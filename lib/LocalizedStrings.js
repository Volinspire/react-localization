...
var LocalizedStrings = function () {
    _createClass(LocalizedStrings, [{
        ...
        value: function _getBestMatchingLanguage(language, props) {
            ...
            return props[auxLang] ? auxLang : (0, _keys2.default)(props)[0];
        }
    }]);
    ...
    _createClass(LocalizedStrings, [{
        ...
        value: function setContent(props) {
            this._defaultLanguage = (0, _keys2.default)(props)[0];
            this._defaultLanguageFirstLevelKeys = [];
            //Store locally the passed strings
            this._props = props;
            utils.validateTranslationKeys((0, _keys2.default)(props[this._defaultLanguage]));
        ...
        value: function setLanguage(language) {
            ...
            var defaultLanguage = (0, _keys2.default)(this._props)[0];
            ...
            if (this._props[bestLanguage]) {
                ...
                try {
                    for (var _iterator = (0, _getIterator3.default)(this._defaultLanguageFirstLevelKeys), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        key = _step.value;
                ...
                var localizedStrings = (0, _assign2.default)({}, this._props[this._language]);
